...
#define WIFI_SSID "NoGiveUp"
#define WIFI_PASSWORD "19122000"

#define FIREBASE_HOST "https://tt-iot-da7d0-default-rtdb.firebaseio.com/"
...
{
  readDHT11();
  if(Firebase.setDouble(fbdo1, "/TT_IoT/nhietdo",temperature))  
    Serial.println("Upload success");  
  else
    Serial.println("Upload fail"); 

     if(Firebase.setDouble(fbdo2, "/TT_IoT/doam",humidity))  
    Serial.println("Upload success");  
  else
    Serial.println("Upload fail"); 
