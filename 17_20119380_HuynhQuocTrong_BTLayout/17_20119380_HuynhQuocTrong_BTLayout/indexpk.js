...
function on4() {
	btn4.style.left = '0'
	document.getElementById("img4").src = "img/quat_on.jpg"
}

function off4() {
	btn4.style.left = '110px'
	document.getElementById("img4").src = "img/quat_off.jpg"
}
